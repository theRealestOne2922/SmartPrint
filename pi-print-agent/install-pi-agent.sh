...
# backend's ALLOWED_KIOSK_IDS.
#
# Each Pi needs its OWN value. When setting up a second Pi, copy MONGODB_URI,
# MASTER_KEY, APP_SECRET and PUBLIC_BASE_URL across from the first — but NOT
# this line. Two agents sharing one kiosk id race for every job and print at
# the wrong location, confidential papers included.
KIOSK_ID=
